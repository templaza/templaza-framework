...
<script type="text/html" id="tmpl-field-tz_layout-template-<?php echo esc_attr($this -> element['id']); ?>">
    <div class="fl_row fl_section" data-fl-element_type="<?php echo esc_attr($this -> element['id']); ?>">
        <!-- Row controls -->
        <div class="fl_controls fl_controls-row uk-clearfix">
            <div class="fl_controls-row-left">
                ...
                echo esc_html__('Drag section to reorder', 'templaza-framework');?>" data-fl-control="move"><i class="fas fa-arrows-alt"></i></a>
                <span class="fl_control fl_control-title"><# if(data.admin_label && data.admin_label.length){ #>
                                {{{data.admin_label}}}<# }else{ #><?php echo esc_html__('Section', 'templaza-framework');
                    ?> <# } #></span>
            </div>
            <div class="fl_controls-row-right">
                <a href="#" class="fl_control fl_column-delete" data-fl-control="delete" data-uk-tooltip="<?php
                echo esc_html__('Remove Section', 'templaza-framework');?>"><i class="far fa-trash-alt"></i></a>
                <a href="javascript:" class="fl_control fl_column-save" data-fl-control="save" data-uk-tooltip="<?php
                echo esc_html__('Save Section', 'templaza-framework');?>"><i class="far fa-save"></i></a>
                <a href="#" class="fl_control fl_column-clone" data-fl-control="clone" data-uk-tooltip="<?php
                echo esc_html__('Duplicate Section', 'templaza-framework');?>"><i class="far fa-copy"></i></a>
                <a href="#" class="fl_control fl_column-edit" data-fl-control="edit" data-uk-tooltip="<?php
                echo esc_html__('Edit Section', 'templaza-framework');?>"><i class="far fa-edit"></i></a>
                <a href="#" class="fl_control fl_column-add-section" data-fl-control="add-section" data-uk-tooltip="<?php
                echo esc_html__('New Section', 'templaza-framework');?>"><i class="fas fa-plus"></i> <?php
                    echo esc_html__('Section', 'templaza-framework');?></a>
                <a href="#" class="fl_control fl_column-add-row" data-fl-control="add-row" data-uk-tooltip="<?php
                echo esc_html__('Add Row', 'templaza-framework');?>"><i class="fas fa-plus"></i> <?php
                    echo esc_html__('Row', 'templaza-framework');?></a>
                <a href="#" class="fl_control fl_column-toggle" data-fl-control="toggle" data-uk-tooltip="<?php
                echo esc_html__('Toggle Section', 'templaza-framework');?>"><i class="fas fa-chevron-down"></i></a>
            </div>
        </div><!-- End row controls -->
        <!-- Row element wrapper -->
        <div class="fl_element-wrapper">
            <div class="fl_row_container uk-child-width uk-grid" data-uk-grid>
                <!-- Column -->
                <div class="fl_column">
                    ...
                    <div class="fl_controls fl_controls-column bottom-controls">
                        ...
                        echo esc_html__('Add Row', 'templaza-framework');?>"><i class="far fa-plus-square"></i> <?php echo esc_html__('Add Row', 'templaza-framework'); ?></a>
