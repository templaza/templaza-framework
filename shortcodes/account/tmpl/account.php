...
extract(shortcode_atts(array(
    ...
    'login_text'                    => esc_html__('Login', $this -> text_domain),
    'register_text'                 => esc_html__('Register', $this -> text_domain),
    'welcome_text'                  => esc_html__('Welcome', $this -> text_domain),
    'edit_profile_text'             => esc_html__('Edit Profile', $this -> text_domain),
