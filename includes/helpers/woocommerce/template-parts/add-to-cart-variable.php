...
do_action( 'woocommerce_before_add_to_cart_form' ); ?>
    ...
    <form class="variations_form cart variations_form_loop"
		...
		<?php if ( empty( $available_variations ) && false !== $available_variations ) : ?>
            <p class="stock out-of-stock"><?php echo esc_html( apply_filters( 'woocommerce_out_of_stock_message', __( 'This product is currently out of stock and unavailable.', 'agruco' ) ) ); ?></p>
		<?php else : ?>
