(function($) {
    ...
    // redux.field_objects.tz_layout.create_default_setting = function(element){
    //     var default_setting = {
    //         type: element.data("fl-element_type"),
    //         elements: [],
    //         params: element.serializeForm()
    //     };
    //     if(typeof element.data("icon") !== typeof undefined){
    //         default_setting.icon    = element.data("icon");
    //     }
    //     if(typeof element.data("title") !== typeof undefined){
    //         default_setting.title    = element.data("title");
    //     }
    //
    //     // Prepare default setting from shortcode element
    //     if(typeof templaza.shortcode !== typeof undefined){
    //         var shortcode = templaza.shortcode;
    //         if(typeof shortcode[element.data("fl-element_type")] !== typeof undefined &&
    //             typeof shortcode[element.data("fl-element_type")]["prepare_setting"] !== typeof undefined){
    //             shortcode[element.data("fl-element_type")]["prepare_setting"](default_setting, element);
    //         }
    //     }
    //
    //     return default_setting;
    ...
    // redux.field_objects.tz_layout.modify_setting = function(src_setting, dest_setting = null, settings, selector, pos = "last"){
    //     if(pos === "last"){
    //         if(dest_setting !== null){
    //             dest_setting.elements.pop();
    //             dest_setting.elements.push(src_setting);
    //         }else{
    //             settings.pop();
    //             settings.push(src_setting);
    ...
    //     }else if(Number.isInteger(pos)){
    //         if(dest_setting !== null){
    //             dest_setting.elements.splice(pos - 1, 1, src_setting);
    //         }else{
    //             settings.splice(pos - 1, 1 , src_setting);
    //         }
    //     }
    //
    //     alert("Modiffy");
        ...
        var init_event  = function(){
            ...
            selector.find("[data-fl-control=edit]").off("click").on("click",function(event){
                ...
                if($("script#tmpl-field-tz_layout-settings-" + element.data("fl-element_type")).length) {
                    ...
                    if (typeof redux.field_objects.tz_tab !== typeof undefined) {
                        redux.field_objects.tz_tab.init(setting_obj);
                    }
