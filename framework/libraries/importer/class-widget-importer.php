...
if(!class_exists("Plzinst_Widget_Importer")){
    class Plzinst_Widget_Importer{

//        public function wie_process_import_file( $file ) {
//
...
//        }
        ...
        public function wie_available_widgets() {
            ...
            return apply_filters( 'plzinst_wie_available_widgets', $available_widgets );
        ...
        public function wie_import_data( $data ) {
            ...
            // Hook before import.
            do_action( 'plzinst_wie_before_import' );
            $data = apply_filters( 'plzinst_wie_import_data', $data );
            ...
            foreach ( $data as $sidebar_id => $widgets ) {
                ...
                foreach ( $widgets as $widget_instance_id => $widget ) {
                    ...
                    $widget = apply_filters( 'plzinst_wie_widget_settings', $widget );
            ...
            // Hook after import.
            do_action( 'plzinst_wie_after_import' );

            // Return results.
            return apply_filters( 'plzinst_wie_import_results', $results );
