...
<div id="vp-pfui-format-quote-fields" style="display: none;" class="vp-pfui-format-wrap">
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote-source-content"><?php _e('Quote Content', 'templaza-framework'); ?></label>
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote-source-author"><?php _e('Quote Author', 'templaza-framework'); ?></label>
    ...
    <div class="vp-pfui-elm-block">
        <label for="vp-pfui-format-quote-source-url"><?php _e('Quote Author URL', 'templaza-framework'); ?></label>
