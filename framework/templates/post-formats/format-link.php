...
<div class="vp-pfui-elm-block vp-pfui-format-wrap" id="vp-pfui-format-link-url" style="display: none;">
    ...
    <div class="vp-pfui-elm-block">
        <label for="vp-pfui-format-link-url-field"><?php esc_html_e('URL', 'templaza-framework'); ?></label>
    ...
    <div>
        <label for="vp-pfui-format-link-title-field"><?php esc_html_e('Title', 'templaza-framework'); ?></label>
