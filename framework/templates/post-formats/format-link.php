...
<div class="vp-pfui-elm-block vp-pfui-format-wrap" id="vp-pfui-format-link-url" style="display: none;">
    ...
    <div class="vp-pfui-elm-block">
        <label for="vp-pfui-format-link-url-field"><?php _e('URL', 'templaza-framework'); ?></label>
    ...
    <div>
        <label for="vp-pfui-format-link-title-field"><?php _e('Title', 'templaza-framework'); ?></label>
