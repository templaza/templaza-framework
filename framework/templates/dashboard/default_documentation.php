...
<a class="uk-button uk-button-default uk-border-pill uk-margin-top" target="_blank" href="https://docs.templaza.com/themes/<?php echo strtolower($theme -> get('Name')); ?>">Read more</a>