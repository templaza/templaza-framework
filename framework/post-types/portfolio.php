...
//            add_action('templaza-framework/post_type/'.$this -> get_post_type().'/registered', array($this, 'register_taxonomy'));
        ...
        {
            $labels = array(
                'name'               => esc_html_x('Portfolio', 'Portfolio General Name', 'templaza-framework'),
                'singular_name'      => esc_html_x('Portfolio Item', 'Portfolio Singular Name', 'templaza-framework'),
                'add_new'            => esc_html_x('Add New', 'Add New Portfolio Name', 'templaza-framework'),
                'add_new_item'       => esc_html__('Add New Portfolio', 'templaza-framework'),
                'all_items'          => esc_html__( 'All Portfolios', 'templaza-framework'),
                'edit_item'          => esc_html__('Edit Portfolio', 'templaza-framework'),
                'new_item'           => esc_html__('New Portfolio', 'templaza-framework'),
                'view_item'          => esc_html__('View Portfolio', 'templaza-framework'),
                'search_items'       => esc_html__('Search Portfolio', 'templaza-framework'),
        ...
        public function register_taxonomy(){
            register_taxonomy(
                ...
                "label"          => esc_html__("Portfolio Categories",'templaza-framework'),
                "singular_label" => esc_html__("Portfolio Categories",'templaza-framework'),
                "rewrite"        => true ));
            ...
            register_taxonomy(
                "portfolio_tag",array($this -> get_post_type()), array(
                    ...
                    "show_in_rest"   => true,
                    'show_admin_column'          => true,
                    "label"          => esc_html__("Portfolio Tags",'templaza-framework'),
                    "singular_label" => esc_html__("Portfolio Tags",'templaza-framework'),
                    "rewrite"        => ''
                )
            );
