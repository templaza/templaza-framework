    ...
    array(
        ...
        'fields'     => array(
            array(
                ...
                'options'  => array(
//                    ''    => esc_html__('Inherit', 'templaza-framework'),
...
//                'default'      => 'circle',
                'required'     => array('preloader-setting','=',array('animations', '')),
            ),
            array(
                ...
                'placeholder'   => esc_html__('Inherit', 'templaza-framework'),
                'default'       => 'spiner',
                'required'      => array('preloader-setting','=',array('fontawesome', '')),
            ),
            array(
                ...
                'required' => array('preloader-setting','=',array('image', '')),
    ...
    array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'step'     => 1,
                'default'  => '300',
                'required' => array('enable-smooth-scroll', '!=', 'off'),
            ),
        )
    )
);
