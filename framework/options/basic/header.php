...
//            'tiles'    => true,
        ...
        array(
            ...
            'default'  => true,
            'on'       => __('Left', $this -> text_domain),
            'off'      => __('Right', $this -> text_domain),
        ),
        ...
        array(
            ...
            'desc'     => __( 'Animation speed by: ms', 'redux-framework-demo' ),
            'default'       => 300,
            'min'           => 100,
            'step'          => 1,
            'max'           => 4000,
...
//    'title'      => __( 'Off-Canvas menu', $this -> text_domain ),
//    'id'         => 'off-canvas-menu',
//    'desc'       => __( 'Customize Off-Canvas style for your site. You must publish content to the Off-Canvas module position or you\'ll see a blank off-canvas menu.', $this -> text_domain ),
//    'subsection' => true,
//    'fields' => array(
//        array(
//            'id'       => 'enable-offcanvas',
...
//    'desc'       => __( 'Customize dropdown animation for mega/dropdown menu.', $this -> text_domain ),
//    'subsection' => true,
//    'required'   => array('header-mode', '=', 'horizontal'),
//    'fields' => array(
//        array(
//            'id'       => 'dropdown-animation-type',
//            'type'     => 'select',
