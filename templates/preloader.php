...
$preloader_size         = isset($options['preloader-size'])?$options['preloader-size']:40;
...
if($preloder_setting == "animations"){
	...
	$styles = [];
	if (!empty($preloader_image) && !empty($preloader_image['background-image'])) {
	    $preloader_background_size      = isset($options['preloader-size'])?$options['preloader-size']:'inherit';
	    $preloader_background_repeat    = isset($options['preloader-repeat'])?$options['preloader-repeat']:'inherit';
	    $preloader_background_position  = isset($options['preloader-position'])?$options['preloader-position']:'inherit';
		$styles[] = 'background-image:url(' . $preloader_image['background-image']. ')';
		$styles[] = 'background-repeat:' . $preloader_background_repeat;
		$styles[] = 'background-size:' . $preloader_background_size;
		$styles[] = 'background-position:' . $preloader_background_position;
		$styles[] = 'height:'.'100%';
		$styles[] = 'width:'.'100%';
	}
...
Templates::add_inline_style('#templaza-preloader{' . ($preloader_bgcolor?'background:'.$preloader_bgcolor.';':'') . 'height:100%;left:0;position:fixed;top:0;width:100%;z-index:99999}');
Templates::add_inline_style($preloaderStyles);
?>
