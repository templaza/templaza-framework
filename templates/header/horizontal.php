...
?>
<!-- header starts -->
<header data-megamenu data-megamenu-class=".has-megamenu" data-megamenu-content-class=".megamenu-container" data-dropdown-arrow="<?php
...
echo $dropdown_animation_type; ?>" data-easing="<?php
echo $dropdown_animation_ease; ?>" data-astroid-trigger="<?php
echo $dropdown_trigger;
?>" data-megamenu-submenu-class=".nav-submenu,.nav-submenu-static" id="templaza-header" class="<?php
echo implode(' ', $class); ?>">
