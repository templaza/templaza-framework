...
<div class="ap-compare-btn-wrap">
    <a href="javascript:" class="uk-button uk-button-primary ap-compare-list-btn<?php echo $has_compare?' ap-compare-has-product':' uk-hidden';?>" data-ap-compare-list-button>
        ...
        <span class="js-ap-text"><?php esc_html_e('Compare list', 'templaza-framework'); ?></span>
        <span class="uk-badge uk-background-default uk-text-emphasis ap-compare-count" data-ap-compare-count><?php echo esc_html($compare_count); ?></span>
    </a>
