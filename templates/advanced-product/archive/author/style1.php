...
<div class="ap-author-block uk-grid-collapse uk-flex-middle ap-author-style1" data-uk-grid>
    <div class="ap-author-img-box">
        ...
        <img class="uk-width-small" width="40" height="40" src="<?php echo esc_url( get_avatar_url( $author_id,300));?>" alt="<?php echo esc_attr(get_the_author_meta( 'display_name' , $author_id ));?>">
        </a>
    </div>
