...
$miscellaneous_icon_color        = isset($options['miscellaneous-icon-color'])?$options['miscellaneous-icon-color']:'';
if(is_array($miscellaneous_icon_color) && isset($miscellaneous_icon_color['rgba'])) {
    $miscellaneous_icon_color  = $miscellaneous_icon_color['rgba'];
}
...
if (!empty($header_text_color)) {
   $header_styles[] = 'header{ color: ' . $header_text_color['rgba'] . ' !important;}';
}
if (!empty($header_heading_color)) {
	$header_styles[] = 'header h1,header h2,header h3,header h4,header h5,header h6{ color: ' . $header_heading_color['rgba'] . ' !important;}';
}
if (!empty($header_link_color)) {
	$header_styles[] = 'header a{ color: ' . $header_link_color['rgba'] . ' !important;}';
}
if (!empty($header_link_hover_color)) {
	$header_styles[] = 'header a:hover{ color: ' . $header_link_hover_color['rgba'] . ' !important;}';
}
...
if (!empty($main_link_color)) {
   $main_menu_styles[] = '.templaza-nav .nav-link{ color: ' . $main_link_color . ' !important;}';
   $main_menu_styles[] = '.templaza-sidebar-menu .nav-link{ color: ' . $main_link_color . ' !important;}';
}
if (!empty($main_link_hover_color)) {
   $main_menu_styles[] = '.templaza-nav .nav-link:hover, .templaza-nav .nav-link:focus{ color: ' . $main_link_hover_color . ' !important;}';
   $main_menu_styles[] = '.templaza-sidebar-menu .nav-link:hover, .templaza-sidebar-menu .nav-link:focus{ color: ' . $main_link_hover_color . ' !important;}';
}
if (!empty($main_link_active_color)) {
   $main_menu_styles[] = '.templaza-nav .nav-link.active{ color: ' . $main_link_active_color . ' !important;}';
   $main_menu_styles[] = '.templaza-sidebar-menu .nav-link.active{ color: ' . $main_link_active_color . ' !important;}';
}
...
if (!empty($sticky_link_color)) {
	$sticky_menu_styles[] = '#templaza-sticky-header .templaza-nav .nav-link{ color: ' . $sticky_link_color . ' !important;}';
	$sticky_menu_styles[] = '#templaza-sticky-header .templaza-sidebar-menu .nav-link{ color: ' . $sticky_link_color . ' !important;}';
}
if (!empty($sticky_link_hover_color)) {
	$sticky_menu_styles[] = '#templaza-sticky-header .templaza-nav .nav-link:hover, .templaza-nav .nav-link:focus{ color: ' . $sticky_link_hover_color . ' !important;}';
	$sticky_menu_styles[] = '#templaza-sticky-header .templaza-sidebar-menu .nav-link:hover, .templaza-sidebar-menu .nav-link:focus{ color: ' . $sticky_link_hover_color . ' !important;}';
}
if (!empty($sticky_link_active_color)) {
	$sticky_menu_styles[] = '#templaza-sticky-header .templaza-nav .nav-link.active{ color: ' . $sticky_link_active_color . ' !important;}';
	$sticky_menu_styles[] = '#templaza-sticky-header .templaza-sidebar-menu .nav-link.active{ color: ' . $sticky_link_active_color . ' !important;}';
}
...
if (!empty($dropdown_main_link_color)) {
   $dropdown_styles[] = '.templaza-nav .megamenu-container .megamenu-title, .templaza-nav .megamenu-container li.nav-item-submenu > a{ color: ' . $dropdown_main_link_color . ' !important;}';
}
if (!empty($dropdown_main_active_link_color)) {
   $dropdown_styles[] = '.templaza-nav .megamenu-container li.nav-item-active > a, .menu_open .menu-go-back .fas{ color: ' . $dropdown_main_active_link_color . ' !important;}';
}
if (!empty($dropdown_main_active_background_color)) {
   $dropdown_styles[] = '.templaza-nav .megamenu-container li.nav-item-active > a{ background-color: ' . $dropdown_main_active_background_color . ' !important;}';
}
if (!empty($dropdown_main_hover_link_color)) {
   $dropdown_styles[] = '.templaza-nav .megamenu-container li > a:hover, .templaza-nav .megamenu-submenu-container .megamenu-submenu li > a:hover{ color: ' . $dropdown_main_hover_link_color . ' !important;}';
}
if (!empty($dropdown_main_hover_background_color)) {
   $dropdown_styles[] = '.templaza-nav .megamenu-container li > a:hover, .templaza-nav .megamenu-submenu-container .megamenu-submenu li > a:hover{ background-color: ' . $dropdown_main_hover_background_color . ' !important;}';
}
...
if (!empty($mobile_active_link_color)) {
   $mobilemenu_styles[] = '.templaza-mobilemenu-container .templaza-mobilemenu-inner .menu-item.active > a, .templaza-mobilemenu-container .templaza-mobilemenu-inner .menu-item.active > .nav-header, .templaza-mobilemenu-container .templaza-mobilemenu-inner .menu-item.nav-item-active > a, .templaza-mobilemenu-container .templaza-mobilemenu-inner .menu-item.active > .menu-indicator .fas, .templaza-mobilemenu-container .templaza-mobilemenu-inner .menu-item.nav-item-active .fas{ color: ' . $mobile_active_link_color . ' !important;}';
}
if (!empty($mobile_active_background_color)) {
   $mobilemenu_styles[] = '.templaza-mobilemenu-container .templaza-mobilemenu-inner .menu-item.active, .templaza-mobilemenu-container .templaza-mobilemenu-inner .menu-item.nav-item-active, .menu-go-back { background-color: ' . $mobile_active_background_color . ' !important;}';
}
?>
...
//Miscellaneous -> Contact Us
$miscellaneous          = [];
if (!empty($miscellaneous_icon_color)) {
	$miscellaneous[]    = '.templaza-contact-info i[class*="fa-"]{color:' . $miscellaneous_icon_color . ' !important;}';
}
