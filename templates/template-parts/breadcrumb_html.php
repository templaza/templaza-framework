...
if ( !is_front_page() ) {
    ...
    /* Home page */
    echo '<li class="item-home-txt"><span>'.esc_html__('You are here: ','templaza-framework').'</span></li>';
    ...
    elseif ( is_single() ) {
        ...
        /* Year link */
        echo '<li class="item-year item-year-' . get_the_time('Y') . '"><a href="' . get_year_link( get_the_time('Y') ) . '" title="' . get_the_time('Y') . '">' . get_the_time('Y') . esc_html__(' Archives','templaza-framework') . '</a></li>';

        /* Month link */
        echo '<li class="item-month item-month-' . get_the_time('m') . '"><a href="' . get_month_link( get_the_time('Y'), get_the_time('m') ) . '" title="' . get_the_time('M') . '">' . get_the_time('M') . esc_html__(' Archives','templaza-framework') . '</a></li>';

        /* Day display */
        echo '<li class="item-current item-' . get_the_time('j') . '"><span class="bread-current bread-' . get_the_time('j') . '"> ' . get_the_time('jS') . ' ' . get_the_time('M') . esc_html__(' Archives','templaza-framework') . '</span></li>';
        ...
        /* Month display */
        echo '<li class="item-month item-month-' . get_the_time('m') . '"><span class="bread-month bread-month-' . get_the_time('m') . '" title="' . get_the_time('M') . '">' . get_the_time('M') . esc_html__(' Archives','templaza-framework') . '</span></li>';

    } elseif ( is_year() ) {

        /* Display year archive */
        echo '<li class="item-current item-current-' . get_the_time('Y') . '"><span class="bread-current bread-current-' . get_the_time('Y') . '" title="' . get_the_time('Y') . '">' . get_the_time('Y') . esc_html__(' Archives','templaza-framework') . '</span></li>';
        ...
        /* Display author name */
        echo '<li class="item-current item-current-' . esc_attr($templaza_userdata->user_nicename) . '"><span class="bread-current bread-current-' . $templaza_userdata->user_nicename . '" title="' . $templaza_userdata->display_name . '">' . esc_html__('Author: ','templaza-framework') . $templaza_userdata->display_name . '</span></li>';

    } elseif ( get_query_var('paged') ) {

        /* Paginated archives */
        echo '<li class="item-current item-current-' . get_query_var('paged') . '"><span class="bread-current bread-current-' . get_query_var('paged') . '" title="Page ' . get_query_var('paged') . '">'.esc_html__('Page','templaza-framework') . ' ' . get_query_var('paged') . '</span></li>';

    } elseif ( is_search() ) {

        /* Search results page */
        echo '<li class="item-current item-current-' . get_search_query() . '"><span class="bread-current bread-current-' . get_search_query() . '" title="' . esc_html__('Search results for: ','templaza-framework') . get_search_query() . '">' . esc_html__('Search results for: ','templaza-framework') . get_search_query() . '</span></li>';

    } elseif ( is_404() ) {

        /* 404 page */
        echo '<li>' . esc_html__('Error 404','templaza-framework') . '</li>';
    }
